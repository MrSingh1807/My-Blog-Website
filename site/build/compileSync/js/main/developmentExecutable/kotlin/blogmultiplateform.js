(function (factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', './kotlin-kotlin-stdlib.js', './kobweb-frontend-kobweb-core.js', './kobweb-frontend-silk-foundation.js', './compose-multiplatform-core-compose-runtime-runtime.js', './html-internal-html-core-runtime.js', './kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js', './kobweb-frontend-silk-widgets.js', './kobweb-frontend-silk-widgets-kobweb.js', './kobweb-frontend-kobweb-silk.js', './html-html-core.js', './kobweb-frontend-kobweb-compose.js', './kobweb-frontend-compose-html-ext.js', './kotlinx-serialization-kotlinx-serialization-core.js', './worker-411f.js', './kotlinx-coroutines-core.js', './kotlinx-serialization-kotlinx-serialization-json.js'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('./kotlin-kotlin-stdlib.js'), require('./kobweb-frontend-kobweb-core.js'), require('./kobweb-frontend-silk-foundation.js'), require('./compose-multiplatform-core-compose-runtime-runtime.js'), require('./html-internal-html-core-runtime.js'), require('./kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat.js'), require('./kobweb-frontend-silk-widgets.js'), require('./kobweb-frontend-silk-widgets-kobweb.js'), require('./kobweb-frontend-kobweb-silk.js'), require('./html-html-core.js'), require('./kobweb-frontend-kobweb-compose.js'), require('./kobweb-frontend-compose-html-ext.js'), require('./kotlinx-serialization-kotlinx-serialization-core.js'), require('./worker-411f.js'), require('./kotlinx-coroutines-core.js'), require('./kotlinx-serialization-kotlinx-serialization-json.js'));
  else {
  ...
  var get_vh = kotlin_org_jetbrains_compose_html_html_core.$_$.l5;
  ...
  var Companion_getInstance_1 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.m3;
  ...
  var leftRight = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.k1;
  var topBottom = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.r2;
  ...
  var fontFamily = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.d1;
  ...
  var rgb = kotlin_org_jetbrains_compose_html_html_core.$_$.f5;
  var rgba = kotlin_org_jetbrains_compose_html_html_core.$_$.e5;
  ...
  var fillMaxSize = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.a1;
  ...
  var Companion_getInstance_4 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.g3;
  ...
  var Input = kotlin_org_jetbrains_compose_html_html_core.$_$.s5;
  var size = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.m2;
  var borderRadius = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.o;
  var Companion_getInstance_6 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.c3;
  ...
  var Companion_getInstance_7 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.i3;
  var textAlign = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.p2;
  var padding_1 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.g2;
  var CenterHorizontally_getInstance = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.i3;
  var border_0 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.q;
  var get_ms = kotlin_org_jetbrains_compose_html_html_core.$_$.u4;
  var CSSTransition_init_$Create$ = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.v2;
  var transition = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.u2;
  var onFocus = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.z1;
  ...
  initMetadataForClass(User, 'User', User, VOID, VOID, VOID, VOID, {0: $serializer_getInstance});
  initMetadataForCompanion(Companion_0);
  initMetadataForObject($serializer_0, '$serializer', VOID, VOID, [GeneratedSerializer]);
  initMetadataForClass(UserWithoutPassword, 'UserWithoutPassword', UserWithoutPassword, VOID, VOID, VOID, VOID, {0: $serializer_getInstance_0});
  ...
  function ComposableSingletons$MainKt$lambda_2$lambda_dts8wk($composer, $changed) {
    ...
    if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(1712232191, $changed, -1, 'ComposableSingletons$MainKt.lambda-2.<anonymous> (main.kt:91)');
      }
  ...
  function ComposableSingletons$MainKt$lambda_3$lambda_ezu85n($composer, $changed) {
    ...
    if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-1088822656, $changed, -1, 'ComposableSingletons$MainKt.lambda-3.<anonymous> (main.kt:94)');
      }
  ...
  function ComposableSingletons$MainKt$lambda_4$lambda_r7ncra(it, $composer, $changed) {
    ...
    if (!(($dirty & 19) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(854823496, $dirty, -1, 'ComposableSingletons$MainKt.lambda-4.<anonymous> (main.kt:120)');
      }
      // Inline function 'kotlin.run' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'ComposableSingletons$MainKt.lambda-4.<anonymous>.<anonymous>' call
      var dispatchReceiver = rememberComposableLambda(-440954647, true, ComposableSingletons$MainKt$lambda_4$lambda$lambda_tu4lbz(it), $composer_0, 54);
  ...
  function ComposableSingletons$MainKt$lambda_4$lambda$lambda_tu4lbz($it) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(-440954647, $changed, -1, 'ComposableSingletons$MainKt.lambda-4.<anonymous>.<anonymous> (main.kt:120)');
        }
        $it($composer_0, 0);
        var tmp_0;
        if (isTraceInProgress()) {
  ...
  function ComposableSingletons$MainKt() {
    ...
    var tmp_2 = this;
    tmp_2.lambda_4_r8sbbm_1 = ComposableLambda$invoke$ref_2(composableLambdaInstance(854823496, false, ComposableSingletons$MainKt$lambda_4$lambda_r7ncra));
  }
  ...
  function main$lambda(ctx) {
    ...
    ctx.get_router_j3zccy_k$().register_vkebx7_k$('/admin/home', ComposableSingletons$MainKt_getInstance().lambda_2_r8sbbo_1);
    ctx.get_router_j3zccy_k$().register_vkebx7_k$('/admin/login', ComposableSingletons$MainKt_getInstance().lambda_3_r8sbbn_1);
    return Unit_getInstance();
  }
  ...
  function main$lambda$lambda($router) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(-1190994075, $changed, -1, 'main.<anonymous>.<anonymous> (main.kt:120)');
        }
        $router.renderActivePage_fc13h0_k$(ComposableSingletons$MainKt_getInstance().lambda_4_r8sbbm_1, $composer_0, 6, 0);
        var tmp_0;
        if (isTraceInProgress()) {
          traceEventEnd();
          tmp_0 = Unit_getInstance();
  ...
  function main$lambda_2($router) {
    return function ($this$renderComposable, $composer, $changed) {
      var $composer_0 = $composer;
      if (isTraceInProgress()) {
        traceEventStart(1108811911, $changed, -1, 'main.<anonymous> (main.kt:119)');
      }
      // Inline function 'kotlin.run' call
      // Inline function 'kotlin.contracts.contract' call
  ...
  function SidePanel($composer, $changed) {
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-908415312);
    if (!($changed === 0) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-908415312, $changed, -1, 'com.example.blogmultiplateform.components.SidePanel (SidePanel.kt:52)');
      }
      $composer_0.startReplaceGroup_5hh8aj_k$(1603119853);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      var selectedNavigationItem$delegate = tmp0_group;
      var tmp_1 = Companion_getInstance_1();
      $composer_0.startReplaceGroup_5hh8aj_k$(1603122880);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      if (false || it_0 === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
        // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>' call
        var value_0 = SidePanel$lambda_1;
      ...
      $composer_0.endReplaceGroup_ek144q_k$();
      var tmp_4 = height(width(padding(tmp_1, tmp1_group), get_px(250)), get_vh(100));
      // Inline function 'org.jetbrains.compose.web.css.Companion.Fixed' call
      Companion_getInstance_2();
      // Inline function 'org.jetbrains.compose.web.css.Position' call
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp_5 = zIndex(backgroundColor(position(tmp_4, 'fixed'), Theme_Secondary_getInstance().get_rgb_18ix0c_k$()), 9);
      // Inline function 'kotlin.run' call
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>' call
      var dispatchReceiver = rememberComposableLambda(1038695591, true, SidePanel$lambda_2(selectedNavigationItem$delegate), $composer_0, 54);
      // Inline function 'androidx.compose.runtime.remember' call
      var $composer_1 = $composer_0;
      sourceInformationMarkerStart($composer_1, 1157296644, 'CC(remember)P(1):Composables.kt#9igjgp');
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      if (invalid || it_1 === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
        // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>.<anonymous>' call
        var value_1 = ComposableLambda$invoke$ref_8(dispatchReceiver);
      ...
      sourceInformationMarkerEnd($composer_1);
      Column(tmp_5, null, null, null, tmp0, $composer_0, 24576, 14);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp2_safe_receiver == null)
      ...
      tmp2_safe_receiver.updateScope_t8jcf_k$(SidePanel$lambda_3($changed));
    }
  }
  function NavigationItem(modifier, isSelected, title, icon, onClick_0, $composer, $changed, $default) {
    ...
    if (!(($dirty & 9363) === 9362) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(1086331591, $dirty, -1, 'com.example.blogmultiplateform.components.NavigationItem (SidePanel.kt:114)');
      }
      var tmp = cursor(classNames(modifier_0._v, ['sidePanelNavigationHoverEffect']), Companion_getInstance_3().get_Pointer_m64vg4_k$());
      $composer_0.startReplaceGroup_5hh8aj_k$(1689373490);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      ...
      // Inline function 'kotlin.contracts.contract' call
      // Inline function 'com.example.blogmultiplateform.components.NavigationItem.<anonymous>' call
      var dispatchReceiver = rememberComposableLambda(1377225892, true, NavigationItem$lambda_0(icon, isSelected, title), $composer_0, 54);
      // Inline function 'androidx.compose.runtime.remember' call
      var $composer_1 = $composer_0;
      sourceInformationMarkerStart($composer_1, 1157296644, 'CC(remember)P(1):Composables.kt#9igjgp');
      // Inline function 'androidx.compose.runtime.cache' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.updateScope_t8jcf_k$(NavigationItem$lambda_1(modifier_0, isSelected, title, icon, onClick_0, $changed, $default));
    }
  }
  function VectorIcon(modifier, pathData, color, $composer, $changed, $default) {
    ...
    if (!(($dirty & 147) === 146) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(2085898436, $dirty, -1, 'com.example.blogmultiplateform.components.VectorIcon (SidePanel.kt:143)');
      }
      var tmp = height(width(id(modifier_0._v, 'svgParent'), get_px(24)), get_px(24));
      $composer_0.startReplaceGroup_5hh8aj_k$(-376270181);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
  ...
  function SidePanel$lambda($selectedNavigationItem$delegate) {
    // Inline function 'androidx.compose.runtime.getValue' call
    getLocalDelegateReference('selectedNavigationItem', KMutableProperty0, true, function () {
      return THROW_ISE();
    });
    return $selectedNavigationItem$delegate.get_value_j01efc_k$();
  }
  function SidePanel$lambda_0($selectedNavigationItem$delegate, _set____db54di) {
    getLocalDelegateReference('selectedNavigationItem', KMutableProperty0, true, function () {
      return THROW_ISE();
    });
    $selectedNavigationItem$delegate.set_value_v1vabv_k$(_set____db54di);
    return Unit_getInstance();
  }
  function SidePanel$lambda_1($this$padding) {
    leftRight($this$padding, get_px(40));
    topBottom($this$padding, get_px(50));
    return Unit_getInstance();
  }
  function SidePanel$lambda$lambda($this$margin) {
    $this$margin.bottom_k4p8ql_k$(get_px(60));
    return Unit_getInstance();
  }
  function SidePanel$lambda$lambda_0($this$margin) {
    $this$margin.bottom_k4p8ql_k$(get_px(30));
    return Unit_getInstance();
  }
  function SidePanel$lambda$lambda_1($this$margin) {
    $this$margin.bottom_k4p8ql_k$(get_px(24));
    return Unit_getInstance();
  }
  function SidePanel$lambda$lambda_2($index, $item, $selectedNavigationItem$delegate) {
    return function () {
      SidePanel$lambda_0($selectedNavigationItem$delegate, $index);
      println($item.get_first_irdx8n_k$() + ' is Clicked');
      return Unit_getInstance();
    };
  }
  function SidePanel$lambda_2($selectedNavigationItem$delegate) {
    return function ($this$Column, $composer, $changed) {
      var $composer_0 = $composer;
      var tmp;
      if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(1038695591, $changed, -1, 'com.example.blogmultiplateform.components.SidePanel.<anonymous> (SidePanel.kt:68)');
        }
        var tmp_0 = Companion_getInstance_1();
        $composer_0.startReplaceGroup_5hh8aj_k$(-1251151233);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        var tmp_1;
        if (false || it === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
          // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>.<anonymous>.<anonymous>' call
          var value = SidePanel$lambda$lambda;
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(-1251145569);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        if (false || it_0 === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
          // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>.<anonymous>.<anonymous>' call
          var value_0 = SidePanel$lambda$lambda_0;
        ...
        $composer_0.endReplaceGroup_ek144q_k$();
        var tmp2_modifier = color(fontSize(fontFamily(margin(tmp_3, tmp1_group), ['ROBOTO']), get_px(14)), Theme_HalfWhite_getInstance().get_rgb_18ix0c_k$());
        SpanText('Dashboard', tmp2_modifier, null, null, $composer_0, 6, 12);
        ...
        if (inductionVariable < times)
          do {
            ...
            $composer_0.startReplaceGroup_5hh8aj_k$(1095245470);
            // Inline function 'androidx.compose.runtime.cache' call
            // Inline function 'kotlin.let' call
            // Inline function 'kotlin.contracts.contract' call
            // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
            ...
            if (false || it_1 === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
              // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>.<anonymous>.<anonymous>.<anonymous>' call
              var value_1 = SidePanel$lambda$lambda_1;
            ...
            $composer_0.endReplaceGroup_ek144q_k$();
            var tmp_9 = margin(tmp_6, tmp0_group_0);
            var tmp_10 = SidePanel$lambda($selectedNavigationItem$delegate) === index;
            var tmp_11 = item.get_first_irdx8n_k$();
            var tmp_12 = item.get_second_jf7fjx_k$();
            $composer_0.startReplaceGroup_5hh8aj_k$(1095251307);
            // Inline function 'androidx.compose.runtime.cache' call
            var invalid = !!($composer_0.changed_kpusro_k$(index) | $composer_0.changed_ga7h3f_k$(item));
            // Inline function 'kotlin.let' call
            // Inline function 'kotlin.contracts.contract' call
            // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
            ...
            if (invalid || it_2 === Companion_getInstance_0().get_Empty_i9b85g_k$()) {
              // Inline function 'com.example.blogmultiplateform.components.SidePanel.<anonymous>.<anonymous>.<anonymous>.<anonymous>' call
              var value_2 = SidePanel$lambda$lambda_2(index, item, $selectedNavigationItem$delegate);
            ...
            var tmp_14 = tmp_13;
            var tmp1_group_0 = (tmp_14 == null ? true : !(tmp_14 == null)) ? tmp_14 : THROW_CCE();
            $composer_0.endReplaceGroup_ek144q_k$();
            NavigationItem(tmp_9, tmp_10, tmp_11, tmp_12, tmp1_group_0, $composer_0, 0, 0);
          }
  ...
  function SidePanel$lambda_3($$changed) {
    return function ($composer, $force) {
  ...
  function NavigationItem$lambda_0($icon, $isSelected, $title) {
    return function ($this$Row, $composer, $changed) {
      var $composer_0 = $composer;
      var tmp;
      if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(1377225892, $changed, -1, 'com.example.blogmultiplateform.components.NavigationItem.<anonymous> (SidePanel.kt:121)');
        }
        VectorIcon(margin_0(Companion_getInstance_1(), VOID, get_px(10)), $icon, $isSelected ? Theme_Primary_getInstance().get_hex_18j4ge_k$() : Theme_HalfWhite_getInstance().get_hex_18j4ge_k$(), $composer_0, 0, 0);
        var tmp0_modifier = color(fontSize(fontFamily(Companion_getInstance_1(), ['ROBOTO']), get_px(16)), $isSelected ? Theme_Primary_getInstance().get_rgb_18ix0c_k$() : Colors_getInstance().get_White_ij46ow_k$());
  ...
  function NavigationItem$lambda_1($modifier, $isSelected, $title, $icon, $onClick, $$changed, $$default) {
    return function ($composer, $force) {
  ...
  function VectorIcon$lambda_0($pathData, $color) {
    return function ($this$Svg, $composer, $changed) {
      var $composer_0 = $composer;
      if (isTraceInProgress()) {
        traceEventStart(-1095977166, $changed, -1, 'com.example.blogmultiplateform.components.VectorIcon.<anonymous> (SidePanel.kt:154)');
      }
      var tmp = id(Companion_getInstance_1(), 'vectorIcon');
      $composer_0.startReplaceGroup_5hh8aj_k$(-203458507);
      // Inline function 'androidx.compose.runtime.cache' call
  ...
  function values() {
    return [Theme_Primary_getInstance(), Theme_Secondary_getInstance(), Theme_LightGray_getInstance(), Theme_HalfWhite_getInstance()];
  }
  ...
  protoOf($serializer).serialize_7v5x2u_k$ = function (encoder, value) {
  ...
  protoOf($serializer_0).serialize_p618g7_k$ = function (encoder, value) {
    var tmp0_desc = this.descriptor_1;
    var tmp1_output = encoder.beginStructure_yljocp_k$(tmp0_desc);
    if (tmp1_output.shouldEncodeElementDefault_x8eyid_k$(tmp0_desc, 0) ? true : !(value.id_1 === '')) {
      tmp1_output.encodeStringElement_1n5wu2_k$(tmp0_desc, 0, value.id_1);
  ...
  function ComposableSingletons$IndexKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_11(composableLambdaInstance(1654542182, false, ComposableSingletons$IndexKt$lambda_1$lambda_5yb608));
  }
  ...
  function HomeScreen($composer, $changed) {
    ...
    if (!($changed === 0) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-1983458070, $changed, -1, 'com.example.blogmultiplateform.pages.admin.HomeScreen (HomePage.kt:32)');
      }
      isUserLoggedIn(ComposableSingletons$HomePageKt_getInstance().lambda_3_r8sbbn_1, $composer_0, 6);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$HomePageKt$lambda_1$lambda_z4100u($this$Column, $composer, $changed) {
    var $composer_0 = $composer;
    if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-1659574524, $changed, -1, 'com.example.blogmultiplateform.pages.admin.ComposableSingletons$HomePageKt.lambda-1.<anonymous> (HomePage.kt:44)');
      }
  ...
  function ComposableSingletons$HomePageKt$lambda_2$lambda_6aeiyn($this$Box, $composer, $changed) {
    var $composer_0 = $composer;
    if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-1969931301, $changed, -1, 'com.example.blogmultiplateform.pages.admin.ComposableSingletons$HomePageKt.lambda-2.<anonymous> (HomePage.kt:40)');
      }
      var tmp = maxWidth(fillMaxSize(Companion_getInstance_1()), get_px(1920));
      Column(tmp, null, null, null, ComposableSingletons$HomePageKt_getInstance().lambda_1_r8sbbp_1, $composer_0, 24576, 14);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$HomePageKt$lambda_3$lambda_mj7y3k($composer, $changed) {
    var $composer_0 = $composer;
    if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-357211999, $changed, -1, 'com.example.blogmultiplateform.pages.admin.ComposableSingletons$HomePageKt.lambda-3.<anonymous> (HomePage.kt:34)');
      }
      var tmp = background(fillMaxSize(Companion_getInstance_1()), Companion_getInstance_4().rgb_udwlgr_k$(155, 155, 155), []);
      var tmp_0 = Center_getInstance();
      Box(tmp, tmp_0, null, ComposableSingletons$HomePageKt_getInstance().lambda_2_r8sbbo_1, $composer_0, 3072, 4);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$HomePageKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_12(composableLambdaInstance(-1659574524, false, ComposableSingletons$HomePageKt$lambda_1$lambda_z4100u));
    var tmp_0 = this;
    tmp_0.lambda_2_r8sbbo_1 = ComposableLambda$invoke$ref_13(composableLambdaInstance(-1969931301, false, ComposableSingletons$HomePageKt$lambda_2$lambda_6aeiyn));
    var tmp_1 = this;
    tmp_1.lambda_3_r8sbbn_1 = ComposableLambda$invoke$ref_14(composableLambdaInstance(-357211999, false, ComposableSingletons$HomePageKt$lambda_3$lambda_mj7y3k));
  }
  ...
  function LoginScreen($composer, $changed) {
    ...
    if (!($changed === 0) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-94528301, $changed, -1, 'com.example.blogmultiplateform.pages.admin.LoginScreen (LoginScreen.kt:67)');
      }
      ...
      $composer_0.startReplaceGroup_5hh8aj_k$(1202401906);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
  ...
  function ComposableSingletons$LoginScreenKt$lambda_1$lambda_y2n5l7($this$Button, $composer, $changed) {
    var $composer_0 = $composer;
    if (isTraceInProgress()) {
      traceEventStart(1843850736, $changed, -1, 'com.example.blogmultiplateform.pages.admin.ComposableSingletons$LoginScreenKt.lambda-1.<anonymous> (LoginScreen.kt:174)');
    }
  ...
  function ComposableSingletons$LoginScreenKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_15(composableLambdaInstance(1843850736, false, ComposableSingletons$LoginScreenKt$lambda_1$lambda_y2n5l7));
  }
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (this.user2__1 == null) {
              ...
              this.$context_1.get_router_j3zccy_k$().navigateTo$default_onbd51_k$('/admin/home');
  ...
  function LoginScreen$lambda$lambda($scope, $context, $errorText$delegate) {
    return function ($this$Column, $composer, $changed) {
      ...
      if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(-846353482, $changed, -1, 'com.example.blogmultiplateform.pages.admin.LoginScreen.<anonymous>.<anonymous> (LoginScreen.kt:82)');
        }
        var tmp_0 = Companion_getInstance_1();
        $composer_0.startReplaceGroup_5hh8aj_k$(908628097);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908636737);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908647727);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908654977);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908666024);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908673185);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.endReplaceGroup_ek144q_k$();
        var tmp_22 = fontSize(fontWeight(fontFamily(borderRadius(color(backgroundColor(size(margin(tmp_19, tmp5_group), get_px(350), get_px(54)), Theme_Primary_getInstance().get_rgb_18ix0c_k$()), Colors_getInstance().get_White_ij46ow_k$()), get_px(4)), ['ROBOTO']), Companion_getInstance_6().get_Medium_1fiba6_k$()), get_px(16));
        $composer_0.startReplaceGroup_5hh8aj_k$(908685483);
        // Inline function 'androidx.compose.runtime.cache' call
        // Inline function 'kotlin.let' call
        // Inline function 'kotlin.contracts.contract' call
        // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(908692825);
        // Inline function 'androidx.compose.runtime.cache' call
        ...
        $composer_0.endReplaceGroup_ek144q_k$();
        var tmp_28 = cursor(onClick(tmp_25, tmp7_group), Companion_getInstance_3().get_Pointer_m64vg4_k$());
        var tmp_29 = get_px(0);
        // Inline function 'org.jetbrains.compose.web.css.Companion.None' call
        Companion_getInstance_5();
        // Inline function 'org.jetbrains.compose.web.css.LineStyle' call
        ...
        var tmp2_modifier = textAlign(fontFamily(color(width(Companion_getInstance_1(), get_px(350)), Colors_getInstance().get_Red_18jks8_k$()), ['ROBOTO']), Companion_getInstance_7().get_Center_3arb0i_k$());
  ...
  function LoginScreen$lambda_2($scope, $context, $errorText$delegate) {
    return function ($this$Box, $composer, $changed) {
      ...
      if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(-950507763, $changed, -1, 'com.example.blogmultiplateform.pages.admin.LoginScreen.<anonymous> (LoginScreen.kt:77)');
        }
  ...
  protoOf(LoginStyle).get_baseStyle_339jzy_k$ = function (_this__u8e3s4) {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = transition(border_0(_this__u8e3s4, tmp, 'solid', Colors_getInstance().get_Transparent_cxh4g9_k$()), [CSSTransition_init_$Create$('border', get_ms(300))]);
  ...
  function loginStyle$lambda$lambda() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return transition_0(border_0(tmp, tmp_0, 'solid', Colors_getInstance().get_Transparent_cxh4g9_k$()), [Companion_getInstance_8().of_ap5umw_k$('border', get_ms(300), null, null)]);
  }
  ...
  function enableHoverEffect$lambda$lambda() {
    return transition_0(backgroundColor(Companion_getInstance_1(), Colors_getInstance().get_White_ij46ow_k$()), [Companion_getInstance_8().of_ap5umw_k$('background-color', get_ms(300), null, null)]);
  }
  ...
  function isUserLoggedIn(content, $composer, $changed) {
    ...
    if (!(($dirty & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(2125572165, $dirty, -1, 'com.example.blogmultiplateform.utils.isUserLoggedIn (Functions.kt:18)');
      }
      var context = rememberPageContext($composer_0, 0);
      $composer_0.startReplaceGroup_5hh8aj_k$(208375236);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      ...
      $composer_0.startReplaceGroup_5hh8aj_k$(208377366);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_1 = $composer_0;
      // Inline function 'kotlin.let' call
      // Inline function 'kotlin.contracts.contract' call
      ...
      $composer_0.startReplaceGroup_5hh8aj_k$(208379285);
      // Inline function 'androidx.compose.runtime.cache' call
      ...
      $composer_0.startReplaceGroup_5hh8aj_k$(208381405);
      // Inline function 'androidx.compose.runtime.cache' call
        ...
        switch (tmp) {
          ...
          case 2:
            ...
            if (!this.$remembered_1 || !isUserLoggedIn$lambda(this.$userIdExist$delegate_1)) {
              this.$context_1.get_router_j3zccy_k$().navigateTo$default_onbd51_k$('/admin/login');
            }
...
//# sourceMappingURL=blogmultiplateform.js.map
