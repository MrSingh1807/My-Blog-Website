(function (factory) {
  ...
  protoOf(Builder).add_8zvck2_k$ = function (key, value) {
    ...
    // Inline function 'kotlin.collections.set' call
    var this_0 = this.extras_1;
    var key_0 = suffixedKey(key, 'ImageData_width');
    var value_0 = value.width;
    this_0.put_4fpzoq_k$(key_0, value_0);
    // Inline function 'kotlin.collections.set' call
    var this_1 = this.extras_1;
    var key_1 = suffixedKey(key, 'ImageData_height');
    var value_1 = value.height;
    this_1.put_4fpzoq_k$(key_1, value_1);
  };
  ...
  protoOf(Transferables).toJson_edh1bx_k$ = function () {
    ...
    // Inline function 'kotlin.collections.toTypedArray' call
    // Inline function 'kotlin.collections.map' call
    var this_4 = this.extras_1.get_entries_p20ztl_k$();
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList_init_$Create$(collectionSizeOrDefault(this_4, 10));
    var tmp0_iterator_0 = this_4.iterator_jk1svi_k$();
