(function (factory) {
  ...
  var flexDirection = kotlin_org_jetbrains_compose_html_html_core.$_$.w3;
  var Companion_getInstance_6 = kotlin_org_jetbrains_compose_html_html_core.$_$.k;
  var justifyContent = kotlin_org_jetbrains_compose_html_html_core.$_$.i4;
  var flexGrow = kotlin_org_jetbrains_compose_html_html_core.$_$.x3;
  ...
  var borderColor_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.p;
  var borderColor_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.q;
  var borderStyle = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.t;
  var borderStyle_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.v;
  var Companion_getInstance_7 = kotlin_org_jetbrains_compose_html_html_core.$_$.l;
  var borderStyle_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.s;
  var borderStyle_2 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.u;
  var borderWidth = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.x;
  var borderWidth_0 = kotlin_org_jetbrains_compose_html_html_core.$_$.l3;
  var borderWidth_1 = kotlin_org_jetbrains_compose_html_html_core.$_$.m3;
  var borderWidth_2 = kotlin_org_jetbrains_compose_html_html_core.$_$.k3;
  var borderBottom = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.m;
  var borderLeft = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.r;
  ...
  function onFocus$lambda($listener) {
    return function ($this$attrsModifier) {
      $this$attrsModifier.onFocus_ozgn2v_k$($listener);
      return Unit_getInstance();
    };
  }
  ...
  function PaddingScope(styleScope) {
    this.styleScope_1 = styleScope;
  }
  protoOf(PaddingScope).left_pqi2av_k$ = function (value) {
    return paddingLeft(this.styleScope_1, value);
  };
  protoOf(PaddingScope).right_1eed0y_k$ = function (value) {
    return paddingRight(this.styleScope_1, value);
  };
  protoOf(PaddingScope).top_1wurxj_k$ = function (value) {
    return paddingTop(this.styleScope_1, value);
  };
