...
public fun main() {
    ...
    AppGlobals.initialize(mapOf("title" to "BlogMultiplateform"))
    BasePath.set("")
    val router = Router()
    ...
    com.varabyte.kobweb.silk.init.additionalSilkInitialization = { ctx ->
        ...
        com.example.blogmultiplateform.styles.loginStyle(ctx)
        com.example.blogmultiplateform.styles.enableHoverEffect(ctx)
    }
    ...
    renderComposable(rootElementId = "root") {
        com.example.blogmultiplateform.AppEntry {
