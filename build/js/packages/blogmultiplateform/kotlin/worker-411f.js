(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof globalThis['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'worker-411f'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'worker-411f'.");
    }
    if (typeof globalThis['kobweb-frontend-kobweb-worker-interface'] === 'undefined') {
      throw new Error("Error loading module 'worker-411f'. Its dependency 'kobweb-frontend-kobweb-worker-interface' was not found. Please, check whether 'kobweb-frontend-kobweb-worker-interface' is loaded prior to 'worker-411f'.");
    }
    if (typeof globalThis['kobweb-frontend-kobweb-worker'] === 'undefined') {
      throw new Error("Error loading module 'worker-411f'. Its dependency 'kobweb-frontend-kobweb-worker' was not found. Please, check whether 'kobweb-frontend-kobweb-worker' is loaded prior to 'worker-411f'.");
    }
    globalThis['worker-411f'] = factory(typeof globalThis['worker-411f'] === 'undefined' ? {} : globalThis['worker-411f'], globalThis['kotlin-kotlin-stdlib'], globalThis['kobweb-frontend-kobweb-worker-interface'], globalThis['kobweb-frontend-kobweb-worker']);
  }
    ...
    return function (e) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          ...
          // Inline function 'kotlin.contracts.contract' call
          // Inline function 'com.example.blogmultiplateform.worker.EchoWorker.worker.<anonymous>.<anonymous>.<anonymous>' call
  ...
  function EchoWorker(onOutput) {
    ...
    var tmp_0 = this;
    // Inline function 'kotlin.apply' call
    var this_0 = new Worker('_kobweb/workers/com-example-blogmultiplateform-worker/worker-411f.js');
    // Inline function 'kotlin.contracts.contract' call
    // Inline function 'com.example.blogmultiplateform.worker.EchoWorker.worker.<anonymous>' call
