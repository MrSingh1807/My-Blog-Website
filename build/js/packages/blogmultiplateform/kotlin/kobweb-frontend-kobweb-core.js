(function (factory) {
  ...
  var dropLast = kotlin_kotlin.$_$.de;
  ...
  var replace = kotlin_kotlin.$_$.ye;
  ...
  function _no_name_provided__qut3iv($worker) {
  ...
  function rememberWorker$lambda($worker) {
    return function ($this$DisposableEffect) {
      ...
      return new _no_name_provided__qut3iv($worker);
    };
  }
  //region block: init
